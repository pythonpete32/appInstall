...
const sabManager = '0x003706e1c4884d70ed2a8804a2439ab2531f2797'
...
async function firstTx() {
    ...
    const addPowerSourceSignature = 'addPowerSource(address _sourceAddr, uint8 _sourceType, uint256 _weight)'
    ...
    const calldatum = await Promise.all([
        ...
        encodeActCall(createSignature, [
            sabVoting,
            '0x47a247add20ddfe9b8e609d756605ca7c34e1d3d',
        ...
        encodeActCall(addPowerSourceSignature, [
            comToken,
            1,
            1
        ]),
...
async function secondTx() {
    ...
    // app initialisation payloads
    const inboxInitPayload = await encodeActCall(inboxInitSignature,[comToken, BN('250000000000000000'), BN('10000000000000000'), 604800])
